    ...
    <>
      ...
      <div className="home-background">
        <main className="flex flex-col items-center justify-between px-16 pb-4 pt-6">
          <div className="mb-4 z-10 max-w-5xl w-full items-center justify-between font-mono text-sm lg:flex mt-2">
          ...
          <div>
            <div className="h-44 w-60 relative my-4">
              <Image
          ...
          <div className=" rounded-lg border border-red-100 p-5 bg-pink-50 mt-8">
            <h2 className="text-2xl m-5">
              Learn about App Development in Next
            </h2>
            <div className="mb-32 grid text-center lg:max-w-5xl lg:w-full lg:mb-0 lg:grid-cols-4 lg:text-left">
              <a
